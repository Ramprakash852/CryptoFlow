            ...
            >
              <table className="pricing-tables-wrap-table-blurring">
                ...
                <tfoot>
                  <tr>
                    <td colSpan={"8"}>
                      A crypto Flow is an online platform for buying, selling,
                      and trading cryptocurrencies like Bitcoin and Ethereum. It
                      functions as an exchange, offering services such as spot
                      trading, futures trading, and staking.These platforms
                      provide secure wallets, transaction tracking, and market
                      analysis tools, with encryption and two-factor
                      authentication ensuring security.
                    </td>
                  </tr>
                </tfoot>
              </table>
